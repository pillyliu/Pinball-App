...
| `/Users/pillyliu/Documents/Codex/Pinball App/Pinball App Android/app/src/main/java/com/pillyliu/pinprofandroid/practice/PracticeScreenRouteContent.kt` | in audit | Healthy route-to-section seam already exists, and the shared context is now narrower after pulling `Game` route dependencies out, but more route-specific fields still need to leave the shared contract. |
