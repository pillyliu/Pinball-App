...
| `/Users/pillyliu/Documents/Codex/Pinball App/Pinball App Android/app/src/main/java/com/pillyliu/pinprofandroid/practice/PracticeScreenRouteContent.kt` | in audit | Shared route content is materially narrower after pulling `Game`, `Home`, `GroupDashboard`, `Insights`, `Mechanics`, and `Settings` dependencies into dedicated contexts, but `Journal` still relies on the shared contract. |
