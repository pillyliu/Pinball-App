...
1. Extend the new brand token layer into the remaining shared chrome: selected states, card highlights, and any remaining top-header treatments that still sit outside the shared seams.
