...
1. Extend the new brand token layer into the remaining shared chrome: segmented controls, feature-level highlight surfaces, and any last top-header treatments still outside the shared seams.
