...
1. Extend the new brand token layer into the remaining shared chrome: any last top-header treatments, segmented/selected states, and feature-level highlight surfaces still outside the shared seams.
